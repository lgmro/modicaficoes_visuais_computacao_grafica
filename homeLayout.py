...
class HomeLayout:
    ...
    def create_buttons(self):
        ...
        self.button_rotate = customtkinter.CTkButton(self.sidebar_frame, text="Rotacionar", command=lambda: asyncio.run(self.view_model.rotate_image(self.slide_rotate())))
